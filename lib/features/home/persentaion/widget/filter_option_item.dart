...
class FilterOptionItem extends StatefulWidget {
  ...
  const FilterOptionItem({super.key, this.state = false, required this.optionName, required this.onItemSelect, required this.id, this.icon});
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: widget.state ? const Border() : Border.all(
            width: 1,color: AppTheme.appGrey8
        )
        ),
        child: Row(
