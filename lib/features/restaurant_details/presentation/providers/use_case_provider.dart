...
import 'package:flutter_base/features/restaurant_details/domain/usecases/fetch_restaurant_reviews_use_case.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

import '../../domain/entities/menu_entity.dart';

final fetchLimitRestaurantMenuItemsStateProvider = StateNotifierProvider.autoDispose<
...
final fetchRestaurantLimitReviewsUseCaseStateProvider = StateNotifierProvider
    .autoDispose<FetchRestaurantReviewsUseCase, StateModel<List<ReviewEntity>>>(
        (ref) => FetchRestaurantReviewsUseCase(
            ref.read(restaurantRepositoryProvider)));

final fetchRestaurantReviewsUseCaseStateProvider = StateNotifierProvider
    .autoDispose<FetchRestaurantReviewsUseCase, StateModel<List<ReviewEntity>>>(
        (ref) => FetchRestaurantReviewsUseCase(
            ref.read(restaurantRepositoryProvider)));
