...
class FetchSingle2ReservationUseCase
  ...
  void call({
    ...
    await _reservationResturantRepo.fetchSingle2ReservationMethod(
      page: page,
      size: size,
