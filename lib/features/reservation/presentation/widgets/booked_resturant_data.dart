...
class BookedResturantData extends StatelessWidget {
  final RsRestaurant rsRestaurant;
  const BookedResturantData({super.key, required this.rsRestaurant});
